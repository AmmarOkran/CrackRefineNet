...
def parse_args():
    ...
    # parser.add_argument('--config', default= './configs/crack_dual/dual_deeplabv3++_link_convnext_AdamW_0.0001_0.0005dec_3000warm_YCD.py', help='test config file path')
    # parser.add_argument('--checkpoint', default= './work_finalized_YCD/dual_deeplabv3++_link_convnext_AdamW_0.0001_0.0005dec_3000warm_YCD_ce_512x512/best_mIoU_iter_40000.pth', help='checkpoint file')
...
def main():
    ...
    benchmark_dict['inference_time'] = round(1/fps, 4)
    print(f'Average fps of {repeat_times} evaluations: '
          f'{benchmark_dict["average_fps"]}')
    print(f'The variance of {repeat_times} evaluations: '
          f'{benchmark_dict["fps_variance"]}')
    print(f'The inference time of {repeat_times} evaluations: '
          f'{benchmark_dict["inference_time"]}')
