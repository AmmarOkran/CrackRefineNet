...
def parse_args():
    ...
    # parser.add_argument('--config', default="configs/crack_test/deeplabv3++_link_convnext_cracks_AdamW_0.0001_0.0005dec_3000warm_YCD.py", help='train config file path')
