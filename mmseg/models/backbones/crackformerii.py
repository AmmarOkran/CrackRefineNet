...
class CrackFormerII(BaseModule):
    ...
    def forward(self, inputs):
        ...
        return [
            dict(idx=indices_1, shape=unpool_shape1, feats=[scale1_1, scale1_2]),
            dict(idx=indices_2, shape=unpool_shape2, feats=[scale2_1, scale2_2]),
            dict(idx=indices_3, shape=unpool_shape3, feats=[scale3_1, scale3_2, scale3_3]),
            dict(idx=indices_4, shape=unpool_shape4, feats=[scale4_1, scale4_2, scale4_3]),
            dict(idx=indices_5, shape=unpool_shape5, feats=[scale5_1, scale5_2, scale5_3]),
            out, input_shape
        ]