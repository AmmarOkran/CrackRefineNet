...
class NStageDeepLabV3PlusHead(BaseDecodeHead):
    def __init__(
        self,
        encoder_channels,
        out_decode=256,
    ...
    def forward(self, *features):
        ...
        h_res_feats = self.block0(features[0][-5])
        concat_features = torch.cat([aspp_features, high_res_features], dim=1)
        # concat_features = torch.cat([self.f_up(aspp_features), self.f_up(high_res_features), h_res_feats], dim=1)
