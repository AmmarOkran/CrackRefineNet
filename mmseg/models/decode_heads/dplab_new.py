...
class NewDeepLabV3Head(BaseDecodeHead):
    def __init__(self, 
                 out_channels=256, 
        ...
        super(NewDeepLabV3Head, self).__init__(**kwargs)
...
@HEADS.register_module()
class NewDeepLabV3PlusHead(BaseDecodeHead):
    def __init__(
        self,
        encoder_channels,
        out_decode=256,
    ...
    def forward(self, *features):
        ...
        if self.num_classes == 3:
            return self.segmentation_head(fused_features), self.mask_head(fused_features)
